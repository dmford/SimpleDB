...
public class Buffer {
  ...
  referenceCount = 5;
   ...
   public boolean saveBlock(Block newBlock) {

  try {

  flush();

  contents.write(newBlock);

  } catch (RuntimeException e) {

  System.out.println("Saving block: " + newBlock.toString() + " failed.");
  ...
  return true;
   ...
   public boolean restoreBlock(Block oldBlock) {

  try {

  flush();

  contents.read(oldBlock);
  ...
  System.out.println("Restoring block: " + oldBlock.toString() + "failed");
